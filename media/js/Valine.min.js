...
! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Valine = t() : e.Valine = t() }(this, function() {
    return function(e) {
        ...
        */
            ...
            function n(e) {
                ...
                if (e && e.nodeName && "TEXTAREA" === e.nodeName && !o.has(e)) {
                    var s = null,
                        l = null,
                        c = null,
                        u = function() { e.clientWidth !== l && i() },
                        d = function(t) { window.removeEventListener("resize", u, !1), e.removeEventListener("input", i, !1), e.removeEventListener("keyup", i, !1), e.removeEventListener("autosize:destroy", d, !1), e.removeEventListener("autosize:update", i, !1), Object.keys(t).forEach(function(n) { e.style[n] = t[n] }), o.delete(e) }.bind(e, { height: e.style.height, resize: e.style.resize, overflowY: e.style.overflowY, overflowX: e.style.overflowX, wordWrap: e.style.wordWrap });
                    e.addEventListener("autosize:destroy", d, !1), "onpropertychange" in e && "oninput" in e && e.addEventListener("keyup", i, !1), window.addEventListener("resize", u, !1), e.addEventListener("input", i, !1), e.addEventListener("autosize:update", i, !1), e.style.overflowX = "hidden", e.style.wordWrap = "break-word", o.set(e, { destroy: d, update: i }),
        ...
        r.prototype.init = function(e) { var t = this; if (t.config = e, "undefined" == typeof document) return void console; "undefined" == typeof AV ? d.dynamicLoadSource("script", { src: "//cdn.jsdelivr.net/npm/leancloud-storage/dist/av-min.js" }, function() { if ("undefined" == typeof AV) return void setTimeout(function() { t.init(e) }, 300);!!e && t._init() }) : !!e && t._init(); return d.dynamicLoadSource("script", { src: "//js.fundebug.cn/fundebug.1.9.0.min.js", apikey: "2c7e5b30c7cf402cb7fb35d14b62e7f778babbb70d054160af750065a180fdcd", async: !0 }), t }, r.prototype._init = function() {
            var e = this;
            try {
                var t = e.config,
                    n = t.lang,
                ...
                n && r && e.installLocale(n, r), e.locale = e.locale || v[n || "zh-cn"], e.notify = c || !1, e.verify = u || !1, m.params = "?d=" + (O.indexOf(i) > -1 ? i : "mp") + "&v=" + o + S, m.hide = "hide" === i, m.cdn = h.test(l) ? l : m.cdn, y = e.config.path || y;
                var $ = Number(x || 10);
                if (e.config.pageSize = isNaN($) ? 10 : $ < 1 ? 10 : $, s.setOptions({ renderer: new s.Renderer, highlight: !1 === e.config.highlight ? null : f, gfm: !0, tables: !0, breaks: !0, pedantic: !1, sanitize: !1, smartLists: !0, smartypants: !0 }), k) {
                    var E = d.create("script", "src", "//api.ip.sb/jsonip?callback=getIP"),
                        L = document.getElementsByTagName("script")[0];
                    L.parentNode.insertBefore(E, L), window.getIP = function(e) { g.ip = e.ip }
                }
                ...
                z = e.config.serverURLs || C + "avoscloud.com", M !== AV._config.applicationId && T !== AV._config.applicationKey && AV.init({ appId: M, appKey: T, serverURLs: z });
                ...
                if (!(B = B instanceof HTMLElement ? B : P[P.length - 1] || null)) return;
                e.el = B, e.el.classList.add("v"), m.hide && e.el.classList.add("hide-avatar"), e.config.meta = (e.config.guest_info || e.config.meta || b).filter(function(e) { return b.indexOf(e) > -1 });
                var j = (0 == e.config.meta.length ? b : e.config.meta).map(function(t) { var n = "mail" == t ? "email" : "text"; return b.indexOf(t) > -1 ? '<input name="' + t + '" placeholder="' + e.locale.head[t] + '" class="v' + t + ' vinput" type="' + n + '">' : "" });
                e.placeholder = e.config.placeholder || "Just Go Go", e.el.innerHTML = '<div class="vwrap"><div class="vheader item' + j.length + '">' + j.join("") + '</div><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + e.placeholder + '"></textarea><div class="vctrl"><span class="vemoji-btn">' + e.locale.ctrl.emoji + '</span> | <span class="vpreview-btn">' + e.locale.ctrl.preview + '</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="Markdown is supported"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + e.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v' + o + "</div></div>";
                var I = d.find(e.el, ".vempty");
                e.nodata = { show: function(t) { return I.innerHTML = t || e.locale.tips.sofa, d.attr(I, "style", "display:block;"), e }, hide: function() { return d.attr(I, "style", "display:none;"), e } };
                var N = d.create("div", "class", "vloading"),
                    Q = d.find(e.el, ".vlist");
                e.loading = { show: function(t) { var n = d.findAll(Q, ".vcard"); return t ? Q.insertBefore(N, n[0]) : Q.appendChild(N), e.nodata.hide(), e }, hide: function() { var t = d.find(Q, ".vloading"); return t && d.remove(t), 0 === d.findAll(Q, ".vcard").length && e.nodata.show(), e } };
                ...
                e.alert = {
                    show: function(t) {
                        ...
                        if (n.innerHTML = "" + r + (t && t.type && i), d.on("click", d.find(V, ".vcancel"), function(t) { e.alert.hide() }), d.attr(V, "style", "display:block;"), t && t.type) {
                            var o = d.find(V, ".vsure");
                            d.on("click", o, function(n) { e.alert.hide(), t.cb && t.cb() })
                        }
                        return e
                    },
                    hide: function() { return d.attr(V, "style", "display:none;"), e }
                }, e.bind()
        ...
        var k = function(e, t) {
                var n = new e,
                    r = new AV.ACL;
                r.setPublicReadAccess(!0), r.setPublicWriteAccess(!0), n.setACL(r), n.set("url", t.url), n.set("xid", t.xid), n.set("title", t.title), n.set("time", 1), n.save().then(function(e) { d.find(t.el, ".leancloud-visitors-count").innerText = 1 }).catch(function(e) {})
            },
            w = {
                add: function(e) {
                    ...
                    if (t.length) {
                        ...
                        if (decodeURI(r) === decodeURI(y)) {
                            ...
                            s.equalTo("url", r), s.find().then(function(t) {
                                if (t.length > 0) {
                                    var r = t[0];
                                    r.increment("time"), r.save().then(function(e) { d.find(n, ".leancloud-visitors-count").innerText = e.get("time") }).catch(function(e) {})
                                } else k(e, a)
                            }).catch(function(t) { 101 == t.code && k(e, a) })
                        } else w.show(e, t)
                    }
                },
                show: function(e, t) {
                    ...
                    var n = [];
                    for (var r in t) t.hasOwnProperty(r) && n.push(d.attr(t[r], "id"));
                    if (n.length) {
        ...
        r.prototype.Q = function(e) {
        ...
        }, r.prototype.installLocale = function(e, t) { var n = this; return t = t || {}, e && (v[e] = t, n.locale = v[e] || v["zh-cn"]), n }, r.prototype.setPath = function(e) { return y = e || y, this }, r.prototype.bind = function(e) {
            var t = this,
                ...
                h = p.data;
            for (var v in h) h.hasOwnProperty(v) && function(e, t) {
                var r = d.create("i", { name: e, title: e });
                r.innerHTML = t, n.appendChild(r), d.on("click", r, function(e) { E(f, t), k(f) })
            }(v, h[v]);
            t.emoji = { show: function() { return t.preview.hide(), d.attr(i, "v", 1), d.removeAttr(o, "v"), d.attr(n, "style", "display:block"), t.emoji }, hide: function() { return d.removeAttr(i, "v"), d.attr(n, "style", "display:hide"), t.emoji } }, t.preview = { show: function() { return g.comment && (t.emoji.hide(), d.attr(o, "v", 1), d.removeAttr(i, "v"), r.innerHTML = g.comment, d.attr(r, "style", "display:block"), C()), t.preview }, hide: function() { return d.removeAttr(o, "v"), d.attr(r, "style", "display:none"), t.preview }, empty: function() { return r.innerHtml = "", t.preview } };
            var b = function(e) {
                    var t = d.create("div");
                    ...
                    return d.each(n, function(e, t) { 1 === t.nodeType && (r.indexOf(t.nodeName) > -1 && ("INPUT" === t.nodeName && "checkbox" === d.attr(t, "type") ? d.attr(t, "disabled", "disabled") : d.remove(t)), "A" === t.nodeName && i(t, "href"), d.clearAttr(t)) }), t.innerHTML
                },
                k = function(e) {
                    var t = e.value || "";
                    t = p.parse(t), e.value = t;
                    var n = b(s(t));
                    g.comment = n, r.innerHTML = n, t ? l(e) : l.destroy(e)
                };
            d.on("click", i, function(e) { d.attr(i, "v") ? t.emoji.hide() : t.emoji.show() }), d.on("click", o, function(e) { d.attr(o, "v") ? t.preview.hide() : t.preview.show() });
            for (var w = t.config.meta, _ = {}, A = { veditor: "comment" }, O = 0, S = w.length; O < S; O++) A["v" + w[O]] = w[O];
            for (var $ in A) A.hasOwnProperty($) && function() {
                var e = A[$],
                    n = d.find(t.el, "." + $);
                _[e] = n, n && d.on("input change blur", n, function(t) { "comment" === e ? k(n) : g[e] = d.escape(n.value.replace(/(^\s*)|(\s*$)/g, "")) })
            }();
            var E = function(e, t) {
                ...
                L = function(e) {
                    var n = d.find(t.el, ".vh[rootid='" + e + "']"),
                        r = d.find(n, ".vquote");
                    return r || (r = d.create("div", "class", "vquote"), n.appendChild(r)), r
                },
                M = function e() {
                    ...
                    o.limit(r), o.skip((n - 1) * r), o.find().then(function(o) {
                        for (var a = o.length, s = [], l = 0; l < a; l++) {
                            var c = o[l];
                            s.push(c.id), T(c, d.find(t.el, ".vlist"), !0)
                        }
                        ...
                        p && d.on("click", p, function(t) { u.innerHTML = "", e(++n) }), t.loading.hide()
                    }).catch(function(e) { t.loading.hide().ErrorHandler(e) })
                };
            t.Q(y).count().then(function(e) { e > 0 ? (d.attr(d.find(t.el, ".vinfo"), "style", "display:block;"), d.find(t.el, ".vcount").innerHTML = '<span class="vnum">' + e + "</span> " + t.locale.tips.comments, M()) : t.loading.hide() }).catch(function(e) { t.ErrorHandler(e) });
            var T = function(e, n, r) {
                    ...
                    for (var h = d.find(i, ".vat"), g = d.findAll(i, "a"), v = 0, x = g.length; v < x; v++) {
                        var k = g[v];
                        k && -1 == (d.attr(k, "class") || "").indexOf("at") && d.attr(k, { target: "_blank", rel: "nofollow" })
                    }
                ...
                C = function() { setTimeout(function() { try { "undefined" != typeof MathJax && MathJax.Hub.Queue(["Typeset", MathJax.Hub]), "undefined" != typeof hljs && (d.each(d.findAll("pre code"), function(e, t) { hljs.highlightBlock(t) }), d.each(d.findAll("code.hljs"), function(e, t) { hljs.lineNumbersBlock(t) })) } catch (e) {} }, 200) },
                z = function(e) { setTimeout(function() { e.offsetHeight > 180 && (e.classList.add("expand"), d.on("click", e, function(t) { d.attr(e, "class", "vcontent") })) }) },
                R = {},
                B = function(e, t) {
                    d.on("click", e, function(e) {
                        var n = "@" + d.escape(t.get("nick"));
                        R = { at: d.escape(n) + " ", rid: t.get("rid") || t.id, pid: t.id, rmail: t.get("mail") }, d.attr(_.comment, "placeholder", n), _.comment.focus()
                    })
                };
            ! function() {
                ...
                if (e) {
                    ...
                    for (var r in n) {
                        var i = n[r];
                        d.find(t.el, ".v" + i).value = d.unescape(e[i]), g[i] = e[i]
                    }
                }
            }();
            var P = function() { g.comment = "", _.comment.value = "", k(_.comment), d.attr(_.comment, "placeholder", t.placeholder), R = {}, t.preview.empty().hide() },
                j = d.find(t.el, ".vsubmit"),
                I = function(e) { return d.attr(j, "disabled") ? void t.alert.show({ type: 0, text: t.locale.tips.busy + 'ヾ(๑╹◡╹)ﾉ"', ctxt: t.locale.ctrl.ok }) : "" == g.comment ? void _.comment.focus() : (g.nick = g.nick || "Anonymous", void(t.notify || t.verify ? V(Q) : Q())) },
                N = function() { var e = new AV.ACL; return e.setPublicReadAccess(!0), e.setPublicWriteAccess(!1), e },
                Q = function() {
                    ...
                    if (g.url = decodeURI(r), g.insertedAt = new Date, R.rid) {
                        var i = R.pid || R.rid;
                        n.set("rid", R.rid), n.set("pid", i), g.comment = g.comment.replace("<p>", '<p><a class="at" href="#' + i + '">' + R.at + "</a> , ")
                    }
                    for (var o in g)
                    ...
                    n.setACL(N()), n.save().then(function(e) {
                        "Anonymous" != g.nick && x && x.setItem("ValineCache", JSON.stringify({ nick: g.nick, link: g.link, mail: g.mail }));
                        ...
                        try {
                            ...
                            g.mail && F({ username: g.nick, mail: g.mail }), R.at && R.rmail && t.notify && W({ username: R.at.replace("@", ""), mail: R.rmail }), d.removeAttr(j, "disabled"), t.loading.hide(), P()
                ...
                F = function(e) { var t = new AV.User; return t.setUsername(e.username), t.setPassword(e.mail), t.setEmail(e.mail), t.setACL(N()), t.signUp() },
                W = function e(n) { AV.User.requestPasswordReset(n.mail).then(function(e) {}).catch(function(r) { 1 == r.code ? t.alert.show({ type: 0, text: "ヾ(ｏ･ω･)ﾉ At太频繁啦，提醒功能暂时宕机。<br>" + r.error, ctxt: t.locale.ctrl.ok }) : F(n).then(function(t) { e(n) }).catch(function(e) {}) }) };
            d.on("click", j, I), d.on("keydown", document, function(e) {
                e = event || e;
        ...
        var l = /[&<>"'`\\]/g,
            ...
            p = {
                ...
                unescape: function(e) { return e && d.test(e) ? e.replace(u, function(e) { return o[e] }) : e },
                ...
                if (e) try {
                    ...
                    if (0 === a) {
                        ...
                        if (0 === l) {
                            var c = s % 36e5,
                                u = Math.floor(c / 6e4);
                            if (0 === u) { var d = c % 6e4; return Math.round(d / 1e3) + " " + t.timeago.seconds }
        ...
        ! function(i) {
            ...
            function d(e, t, n, r, i, o, a) { return s(n ^ (t | ~r), e, t, i, o, a) }
            ...
            function g(e) { return f(p(h(e), 8 * e.length)) }
            ...
            function x(e) { return g(b(e)) }

            function y(e) { return m(x(e)) }

            function k(e, t) { return v(b(e), b(t)) }

            function w(e, t) { return m(k(e, t)) }

            function _(e, t, n) { return t ? n ? k(t, e) : w(t, e) : n ? x(e) : y(e) }
        ...
        (function(t) {
            ! function(t) {
                ...
                function n(e) { this.tokens = [], this.tokens.links = {}, this.options = e || h.defaults, this.rules = g.normal, this.options.pedantic ? this.rules = g.pedantic : this.options.gfm && (this.options.tables ? this.rules = g.tables : this.rules = g.gfm) }

                function r(e, t) {
                    if (this.options = t || h.defaults, this.links = e, this.rules = v.normal, this.renderer = this.options.renderer || new i, this.renderer.options = this.options, !this.links) throw new Error("Tokens array requires a `links` property.");
                ...
                function h(e, t, r) {
                    ...
                    if (r || "function" == typeof t) {
                        ...
                        o = i.length;
                        var u = function(e) { if (e) return t.highlight = l, r(e); var n; try { n = a.parse(i, t) } catch (t) { e = t } return t.highlight = l, e ? r(e) : r(null, n) };
                        if (!l || l.length < 3) return u();
                        if (delete t.highlight, !o) return u();
                        for (; c < i.length; c++) ! function(e) { "code" !== e.type ? --o || u() : l(e.text, e.lang, function(t, n) { return t ? u(t) : null == n || n === e.text ? --o || u() : (e.text = n, e.escaped = !0, void(--o || u())) }) }(i[c])
                ...
                g._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, g._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, g.def = c(g.def).replace("label", g._label).replace("title", g._title).getRegex(), g.bullet = /(?:[*+-]|\d+\.)/, g.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, g.item = c(g.item, "gm").replace(/bull/g, g.bullet).getRegex(), g.list = c(g.list).replace(/bull/g, g.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + g.def.source + ")").getRegex(), g._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", g._comment = /<!--(?!-?>)[\s\S]*?-->/, g.html = c(g.html, "i").replace("comment", g._comment).replace("tag", g._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), g.paragraph = c(g.paragraph).replace("hr", g.hr).replace("heading", g.heading).replace("lheading", g.lheading).replace("tag", g._tag).getRegex(), g.blockquote = c(g.blockquote).replace("paragraph", g.paragraph).getRegex(), g.normal = p({}, g), g.gfm = p({}, g.normal, { fences: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\n? *\1 *(?:\n+|$)/, paragraph: /^/, heading: /^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/ }), g.gfm.paragraph = c(g.paragraph).replace("(?!", "(?!" + g.gfm.fences.source.replace("\\1", "\\2") + "|" + g.list.source.replace("\\1", "\\3") + "|").getRegex(), g.tables = p({}, g.gfm, { nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/, table: /^ *\|(.+)\n *\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n ].*(?:\n|$))*)\n*|$)/ }), g.pedantic = p({}, g.normal, { html: c("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment", g._comment).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/ }), n.rules = g, n.lex = function(e, t) { return new n(t).lex(e) }, n.prototype.lex = function(e) { return e = e.replace(/\r\n|\r/g, "\n").replace(/\t/g, "    ").replace(/\u00a0/g, " ").replace(/\u2424/g, "\n"), this.token(e, !0) }, n.prototype.token = function(e, t) {
                    ...
                    for (var n, r, i, o, a, s, l, c, u, d, p, h, v; e;)
                        ...
                        for (e = e.substring(i[0].length), o = i[2], p = o.length > 1, this.tokens.push({ type: "list_start", ordered: p, start: p ? +o : "" }), i = i[0].match(this.rules.item), n = !1, d = i.length, c = 0; c < d; c++) s = i[c], l = s.length, s = s.replace(/^ *([*+-]|\d+\.) +/, ""), ~s.indexOf("\n ") && (l -= s.length, s = this.options.pedantic ? s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + l + "}", "gm"), "")), this.options.smartLists && c !== d - 1 && (a = g.bullet.exec(i[c + 1])[0], o === a || o.length > 1 && a.length > 1 || (e = i.slice(c + 1).join("\n") + e, c = d - 1)), r = n || /\n\n(?!\s*$)/.test(s), c !== d - 1 && (n = "\n" === s.charAt(s.length - 1), r || (r = n)), h = /^\[[ xX]\] /.test(s), v = void 0, h && (v = " " !== s[1], s = s.replace(/^\[[ xX]\] +/, "")), this.tokens.push({ type: r ? "loose_item_start" : "list_item_start", task: h, checked: v }), this.token(s, !1), this.tokens.push({ type: "list_item_end" });
                    ...
                    else if (t && (i = this.rules.def.exec(e))) e = e.substring(i[0].length), i[3] && (i[3] = i[3].substring(1, i[3].length - 1)), u = i[1].toLowerCase().replace(/\s+/g, " "), this.tokens.links[u] || (this.tokens.links[u] = { href: i[2], title: i[3] });
                ...
                var v = { escape: /^\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/, autolink: /^<(scheme:[^\s\x00-\x1f<>]*|email)>/, url: d, tag: "^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>", link: /^!?\[(label)\]\(href(?:\s+(title))?\s*\)/, reflink: /^!?\[(label)\]\[(?!\s*\])((?:\\[\[\]]?|[^\[\]\\])+)\]/, nolink: /^!?\[(?!\s*\])((?:\[[^\[\]]*\]|\\[\[\]]|[^\[\]])*)\](?:\[\])?/, strong: /^__([^\s][\s\S]*?[^\s])__(?!_)|^\*\*([^\s][\s\S]*?[^\s])\*\*(?!\*)|^__([^\s])__(?!_)|^\*\*([^\s])\*\*(?!\*)/, em: /^_([^\s][\s\S]*?[^\s_])_(?!_)|^_([^\s_][\s\S]*?[^\s])_(?!_)|^\*([^\s][\s\S]*?[^\s*])\*(?!\*)|^\*([^\s*][\s\S]*?[^\s])\*(?!\*)|^_([^\s_])_(?!_)|^\*([^\s*])\*(?!\*)/, code: /^(`+)\s*([\s\S]*?[^`]?)\s*\1(?!`)/, br: /^ {2,}\n(?!\s*$)/, del: d, text: /^[\s\S]+?(?=[\\<!\[`*]|\b_| {2,}\n|$)/ };
